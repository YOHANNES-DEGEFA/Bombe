...
export const DEFAULT_KEYWORDS =
  "Bombe, Bombe movies, Bombe TV, Bombe streaming, movies, tv shows, streaming, watch online, trending movies, popular tv shows, watchlist, film recommendations";
...
export function getSiteUrl() {
  ...
  return "https://bombe-omega.vercel.app";
}
...
export function buildOrganizationJsonLd() {
  ...
  const sameAs = socialProfiles
    ? socialProfiles.split(",").map((url) => url.trim()).filter(Boolean)
    : [];
...
export function buildWebSiteJsonLd() {
  ...
  return {
    ...
    "@id": `${siteUrl}/#website`,
    name: SITE_NAME,
    alternateName: ["Bombe Movies", "Bombe TV", "Bombe Streaming"],
    description: DEFAULT_DESCRIPTION,
    url: siteUrl,
